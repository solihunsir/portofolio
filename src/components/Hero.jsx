            ...
            <div style={{ position: "relative", animation: "float-up 5s ease-in-out infinite" }}>
              ...
              {!showOTW && (
                <div style={{
                  ...
                  <div>
                    <p style={{ fontSize: "0.58rem", color: "#94a3b8", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em" }}>Specialist</p>
                    <p style={{ fontSize: "0.72rem", fontWeight: 700, color: "#041E42" }}>Fullstack Developer</p>
                  </div>
                </div>
              )}
